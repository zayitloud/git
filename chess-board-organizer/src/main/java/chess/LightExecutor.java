...
public class LightExecutor {
	 ...
	 */
	private List<LightBoard> boards;
	...
	private Logger log= LoggerFactory.getLogger(LightExecutor.class);
...
//		this(new String[]{"4","4","1","2","1","0","0","50000"});		
	 ...
	 */
	public LightExecutor(String args[])
	{
		...
		this.args=args;
		boards=new ArrayList<LightBoard>();
	 ...
	 */
	private boolean matchPreviousCombinationOfCoordinates(String pieceType, Map<String,String> currentCombination, String newPosition, List<LightBoard> boardsList)
	{
...
//			return 6;
	 ...
	 */
	private boolean checkNewPieceOnBoard(Piece piece, Coordinate proposedPosition, LightBoard board)
	{
		 Map<String,String> occupiedSlots=board.getOccupiedSlots();
		 Collection<String> slots=occupiedSlots.values();
	 ...
	 */
	private List<Board> getAlternateBoards(LightBoard board)
	{
	 ...
	 */
	private void getAlternateBoards(LightBoard board, short direction, List<LightBoard> alternateBoards)
	{
		LightBoard alternateBoard=null;
		LightBoard previousBoard=null;
		Map<String, String> occupiedSlots = board.getOccupiedSlots();
		Collection<String> values = occupiedSlots.values();
		...
		for(int i=1;i<boardSize;i++)
		{
			...
			alternateBoard= new LightBoard(board.getSize().getX(),board.getSize().getY());
